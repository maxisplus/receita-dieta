...
export interface MenuItem {
  item: string;
  kcal: number;
  alternatives?: [MenuItemAlternative, MenuItemAlternative];
}
            ...
            items: [
              {
                ...
                alternatives: [
                  ...
                  { item: "Overnight oats (aveia + iogurte) 50g", kcal: 250 },
                ],
              },
              {
                item: "1 col. de chia",
            ...
            items: [
              {
                ...
                alternatives: [
                  { item: "2 torradas integrais", kcal: 100 },
                  { item: "Tapioca pequena (30g)", kcal: 100 },
                ],
              },
              {
                item: "2 ovos cozidos",
            ...
            items: [
              ...
              },
              {
                ...
                alternatives: [
                  ...
                  { item: "1 col. de oliva extra virgem", kcal: 40 },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                alternatives: [
                  ...
                  { item: "120g atum fresco ou enlatado", kcal: 240 },
                ],
              },
              {
                item: "100g arroz (cozido)",
                kcal: 130,
                alternatives: [
                  { item: "100g arroz 7 grãos", kcal: 140 },
            ...
            items: [
              {
                ...
                kcal: 220,
                alternatives: [
                  { item: "Panqueca de aveia (2 un) com frango desfiado", kcal: 260 },
              ...
              },
              {
                ...
                alternatives: [
                  { item: "Canela", kcal: 0 },
                  { item: "Cacau em pó (sem açúcar)", kcal: 5 },
                ],
              },
              {
            ...
            items: [
              ...
              },
              {
                ...
                alternatives: [
                  ...
                  { item: "Nibs de cacau (opcional)", kcal: 50 },
                ],
              },
            ],
          },
            ...
            items: [
              {
                ...
                alternatives: [
                  ...
                  { item: "130g salmão ou sardinha", kcal: 200 },
                ],
              },
              {
                item: "100g arroz (cozido)",
            ...
            items: [
              ...
              },
              {
                ...
                alternatives: [
                  ...
                  { item: "1 col. mel (pequena)", kcal: 30 },
                ],
              },
              {
            ...
            items: [
              {
                ...
                kcal: 300,
                alternatives: [
                  { item: "Wrap integral de carne (pequeno) com queijo", kcal: 320 },
            ...
            items: [
              {
                ...
                kcal: 250,
                alternatives: [
                  { item: "Salada de grão-de-bico com sardinha (porção)", kcal: 280 },
                  { item: "Bowl de quinoa/cevada com legumes", kcal: 260 },
                ],
              },
              {
                item: "1 col. de azeite",
            ...
            items: [
              {
                ...
                alternatives: [
                  ...
                  { item: "150g filé mignon (ou corte magro)", kcal: 300 },
                ],
              },
              {
        ...
        options: [
          {
            items: [
              {
                item: "1 copo leite desnatado ou iogurte",
                kcal: 90,
                alternatives: [
        ...
        options: [
          {
            items: [
              {
                item: "Frango ao curry simples 120g",
                kcal: 220,
                alternatives: [
                  { item: "150g peito de frango grelhado", kcal: 250 },
          ...
          },
          {
            items: [
              {
                item: "Sopa de frango com legumes (porção)",
                kcal: 200,
                alternatives: [
                  { item: "Sopa de lentilha com legumes (porção)", kcal: 200 },
                  { item: "Sopa de legumes com carne (porção)", kcal: 220 },
          ...
          },
          {
            items: [
              ...
              },
              {
                ...
                alternatives: [
                  { item: "100g feijão cozido", kcal: 80 },
                  { item: "80g feijão tropeiro fit", kcal: 90 },
                ],
              },
              {
                item: "Salada simples",
          ...
          },
          {
            items: [
              ...
              },
              {
                ...
                alternatives: [
                  { item: "100g arroz (cozido)", kcal: 130 },
                  { item: "80g macarrão integral (cozido)", kcal: 110 },
                ],
              },
              {
                item: "80g feijão",
            ...
            items: [
              {
                ...
                alternatives: [
                  { item: "1 lata de atum em água (100g)", kcal: 120 },
                  { item: "120g tilápia ao forno", kcal: 160 },
                ],
              },
              {
            ...
            items: [
              {
                ...
                kcal: 250,
                alternatives: [
                  { item: "Wrap simples com frango desfiado (tortilla caseira)", kcal: 300 },
                  { item: "Frango desfiado 120g", kcal: 200 },
                ],
              },
              {
            ...
            items: [
              {
                ...
                kcal: 320,
                alternatives: [
                  { item: "1 fatia de pão integral com abacate (pequena)", kcal: 160 },
                  { item: "2 ovos mexidos com tomate", kcal: 156 },
                ],
              },
              {
            ...
            items: [
              {
                ...
                kcal: 320,
                alternatives: [
                  { item: "Pizza fit de frigideira (2 fatias caseiras)", kcal: 300 },
                  { item: "Wrap simples com frango desfiado (tortilla caseira)", kcal: 300 },
                ],
              },
              {
            ...
            items: [
              {
                ...
                kcal: 160,
                alternatives: [
                  { item: "150g peixe assado (opções locais/mais baratas)", kcal: 200 },
                  { item: "130g salmão ou sardinha", kcal: 200 },
                ],
              },
              {
