      ...
      {isOpen && (
        <div className="space-y-3 px-5 pb-4">
          {option.items.map((item, ii) => (
            <div
              key={ii}
              className="group/item rounded-lg border border-gray-100 bg-white/60 py-2.5 px-3 transition-colors hover:border-[rgb(255,145,26)]/20 hover:bg-orange-50/30"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-medium text-gray-800 leading-snug">
                    <span className="text-[rgb(255,145,26)] mr-1.5">•</span>
                    {item.item}
                  </p>
                  {item.alternatives && item.alternatives.length > 0 && (
                    <div className="mt-2 ml-4 pl-3 border-l-2 border-[rgb(255,145,26)]/30">
                      <p className="text-[11px] font-medium uppercase tracking-wider text-[rgb(255,145,26)]/80 mb-1">
                        Alternativas
                      </p>
                      <div className="flex flex-wrap gap-1.5">
                        {item.alternatives.map((alt, ai) => (
                          <span
                            key={ai}
                            className="inline-flex max-w-full items-center rounded-md bg-[rgb(255,145,26)]/10 px-2 py-1 text-xs text-gray-700 ring-1 ring-[rgb(255,145,26)]/20"
                          >
                            {alt.item}
                          </span>
                        ))}
                ...
                <span className="text-xs font-semibold font-mono text-gray-500 tabular-nums shrink-0 rounded bg-gray-100 px-2 py-1">
                  {item.kcal}
